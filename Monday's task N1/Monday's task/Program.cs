...
float valueRub = (float) (valueManat / 0.0265) ; //0.0265Man =1Rub that is why the valueManat is divided into 1.7

string generalvalueEur = "Avro (EUR)";
float valueEUR = (float)(valueManat / 1.8282); //1.8282Man =1Usd that is why the valueManat is divided into 1.7
