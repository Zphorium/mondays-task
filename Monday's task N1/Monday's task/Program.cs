...
string generalvalueRub = "Rusiya rublu (RUB)"; //1.7Man =1Usd that is why the valueManat is divided into 0.0265
float valueRub = (float) (valueManat / 0.0265) ;
//if exchange rate chanege just change number 

string generalvalueEur = "Avro (EUR)";
float valueEUR = (float)(valueManat / 1.8282); //1.7Man =1Usd that is why the valueManat is divided into 1.8282
//if exchange rate chanege just change number 
